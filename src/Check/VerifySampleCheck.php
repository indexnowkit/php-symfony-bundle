...
final class VerifySampleCheck implements CheckInterface
{
     ...
     * @param string|null                   $level   its level (`ok` / `warning`), from `OptionalPackage::checkLevel()`
     */
    public function __construct(private readonly SampleOptions $options, private readonly ?Closure $factory, private readonly ?string $missing = null, private readonly ?string $level = null) {}
